...
def run():
    st.markdown('''<h1 style='text-align: center; color: #d73b5c;'>Resume Screening</h4>''',unsafe_allow_html=True)
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                try:
                    ...
                    pass
                working_experience=resume_data.get('experience')
                cand_level = ''
                if resume_data['no_of_pages'] == 1 or working_experience==None:
                    cand_level = "Fresher"
